...
export function SoundStem7ConjugationTemplate(root: VerbRoot, stemData: VerbStemData<LebaneseStem1Context>, params: ConjugationParams): ConjugationRule[] | undefined
{
    return [
        {
            conditions: {},
            ...
            children: [
                ...
                },
                {
                    ...
                    prefixVowel: Vowel.ShortU,
                    vowels: [Vowel.Sukun, Vowel.ShortU, Vowel.ShortI]
                },
            ]
        },
    ];
