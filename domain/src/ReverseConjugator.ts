...
import { VerbReverseConjugationResult, Conjugator } from "./Conjugator";
...
import { MSAReverseConjugator } from "./dialects/msa/MSAReverseConjugator";
...
export class ReverseConjugator
{
    ...
    private TryReconstructConjugationParamsForResult(result: ReverseConjugationResult)
    {
        ...
        const dialectMetadata = GetDialectMetadata(DialectType.ModernStandardArabic);
