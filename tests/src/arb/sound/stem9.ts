...
import { ConjugationTest, _Legacy_RunActiveParticipleTest, _Legacy_RunConjugationTest, _LegacyRunVerbalNounTest } from "../../shared";
...
It("Stem 9", () => {
    ...
    _LegacyRunVerbalNounTest(root, stem, "اِحْمِرَار");
