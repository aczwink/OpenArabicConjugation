...
import { VerbTestData, RunSoundEqualityTest, RunConjugationTest, RunActiveParticipleTest, RunVerbalNounTest } from "../../shared";
...
It("R1:ي stem 5", () => {
    ...
    RunVerbalNounTest(verbData.rootRadicals, verbData.stem, "تَيَسُّر");
