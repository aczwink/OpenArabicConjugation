...
It("Stem 10: اِسْتَكْتَبَ - يَسْتَكْتِبُ", () => {
    ...
    _LegacyRunVerbalNounTest(root, stem, "اِسْتِكْتَاب");
    _Legacy_RunParticipleTest(root, stem, "مُسْتَكْتِب", "مُسْتَكْتَب");
    ...
    _Legacy_RunConjugationTest("ك-ت-ب", 10, conjugations);
});