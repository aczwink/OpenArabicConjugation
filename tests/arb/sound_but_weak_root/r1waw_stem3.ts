...
import { VerbTestData, RunSoundEqualityTest, RunConjugationTest, RunParticipleTest, RunVerbalNounPatternTest } from "../../shared";
...
It("R1:و stem 3", () => {
    ...
    RunVerbalNounPatternTest(verbData.stem, [
        { rootRadicals: "و-ج-ه", expected: "مُوَاجَهَة" }, //Source: https://en.wiktionary.org/wiki/%D9%88%D8%A7%D8%AC%D9%87
        { rootRadicals: "و-ص-ل", expected: "وِصَال" }, //Source: https://en.wiktionary.org/wiki/%D9%88%D8%B5%D8%A7%D9%84
    ]);
