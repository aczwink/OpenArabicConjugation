...
//Source: https://en.wiktionary.org/wiki/%D8%A7%D8%B3%D8%AA%D9%87%D8%AF%D9%89

It("Stem 10", () => {
    const root = "ه-د";
    const stem = 10;

    RunDefectiveParticipleTest(root, stem, "مُسْتَهْدٍ", "مُسْتَهْدًى");
    RunDefectiveVerbalNounTest(root, stem, "اِسْتِهْدَاء");
