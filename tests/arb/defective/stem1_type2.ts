...
import { ConjugationTest, _Legacy_RunConjugationTest, RunDefectiveParticipleTest, RunVerbalNounPatternTest } from "../../shared";
...
It("Wikipedia defective stem1 type 2", () => {
    ...
    _Legacy_RunConjugationTest("د-ع-و", stem, conjugations);
});